 ...
 * tags:
 *   - name: Activities
 *     description: Manage activities dataset (ADMIN/EDITOR)
 */
 ...
 *   get:
 *     tags: [Activities]
 *     summary: List activities (ADMIN/EDITOR)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: query
 ...
 *       403:
 *         description: Forbidden (role required)
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/ErrorResponse'
 ...
 *   post:
 *     tags: [Activities]
 *     summary: Create activity (ADMIN/EDITOR)
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 *       required: true
 ...
 *   get:
 *     tags: [Activities]
 *     summary: Get activity by id (ADMIN/EDITOR)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *   put:
 *     tags: [Activities]
 *     summary: Update activity (ADMIN/EDITOR)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 *       409:
 *         description: Activity is used in planned activities
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/ErrorResponse'
